...
Con la llegada de los **Modelos de Razonamiento Nativo** (como GPT-5.2 Thinking o Claude 3.5/Opus 4.6), la regla de oro de la Fase T ha cambiado. Antes, debíamos simular el razonamiento guiando al modelo de la mano; hoy, el modelo ya "piensa" por defecto, y guiarlo en exceso puede ser contraproducente.
